...
template ctcStatus_t compute_ctc_loss_cpu<float>(
...
template ctcStatus_t compute_ctc_loss_cpu<double>(
    const double* const activations, double* gradients,
    const int* const flat_labels, const int* const label_lengths,
    const int* const input_lengths, int alphabet_size, int minibatch,
    double* costs, void* workspace, ctcOptions);

template ctcStatus_t get_workspace_size<float>(const int* const label_lengths,
                                               const int* const input_lengths,
                                               int alphabet_size, int minibatch,
                                               ctcOptions, size_t* size_bytes);

template ctcStatus_t get_workspace_size<double>(const int* const label_lengths,
                                                const int* const input_lengths,
                                                int alphabet_size,
                                                int minibatch, ctcOptions,
                                                size_t* size_bytes);
